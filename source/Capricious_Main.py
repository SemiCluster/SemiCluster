...
"""
    This is Capricious  Data Stream!
"""
if __name__ == '__main__':

    dataset = "wpbc" # wpbc; australian
    ...
    Cumulative_error_rate_semi(Y_label_fill_x_ensemble, Y_label_fill_z_ensemble, Y_label_fill_x, Y_label_fill_z, Y_label, dataset)
    ...
    Z_impl_CER_fill, _ = generate_X_Y(n, X_input_z_imp, Y_label_fill_z, Y_label, decay_choice, contribute_error_rate)
