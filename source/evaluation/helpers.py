...
def grassman_dist(A,B):
    # np.linalg.svd将一个比较复杂的矩阵用更小更简单的3个子矩阵的相乘来表示，这3个小矩阵描述了大矩阵重要的特性。
...
def get_tra_hyperparameter(dataset):
    decay_choices             = {"ionosphere": 4,     "wbc": 1,     "wdbc": 3,     "german": 2,      "diabetes": 2,    "credit":4,         "australian":4,     "svmguide3":4,    "kr_vs_kp":4,     "magic04":4,    "wpbc": 4     ,"a8a": 4     , "splice":4    , "dna": 4    , "steamData":4}
    contribute_error_rates    = {"ionosphere": 0.01,  "wbc": 0.005, "wdbc": 0,     "german": 0.005,  "diabetes": 0,    "credit":0.01,      "australian":0.02,  "svmguide3":0.01, "kr_vs_kp":0.01,  "magic04":0.01, "wpbc": 0.01  ,"a8a": 0.01  , "splice":0.01 , "dna": 0.01 , "steamData":0.01}
    window_size_denominators  = {"ionosphere": 2,     "wbc": 2,     "wdbc": 2,     "german": 8,      "diabetes": 2,    "credit":2,         "australian":2,     "svmguide3":2,    "kr_vs_kp":2,     "magic04":2,    "wpbc": 8     ,"a8a": 4     , "splice":8    , "dna": 4    , "steamData":4}
    batch_size_denominators   = {"ionosphere": 20,    "wbc": 8,     "wdbc": 9,     "german": 8,      "diabetes": 8,    "credit":4,         "australian": 10,   "svmguide3": 8,   "kr_vs_kp": 8,    "magic04":2,    "wpbc": 8     ,"a8a": 8     , "splice":8    , "dna": 8    , "steamData":8}
    shuffles                  = {"ionosphere": False, "wbc": True,  "wdbc": True,  "german": False,  "diabetes": True, "credit":True,      "australian":False, "svmguide3":True, "kr_vs_kp":False, "magic04":True, "wpbc": False ,"a8a": False , "splice":True , "dna": False, "steamData":False}
...
def get_cap_hyperparameter(dataset):
    decay_choices            = {"ionosphere": 4,     "wbc": 2,    "wdbc": 0,     "german": 3,     "diabetes": 2,     "credit": 4,         "australian":4,      "wpbc": 4,     "trapezoid": 2     , "kr_vs_kp":4,     "svmguide3":4,    "magic04":4,    "imdb":2,     "synthetic":4     ,"a8a": 4     , "splice":4    , "dna": 4     , "hapt": 4     , "steamData": 4}
    contribute_error_rates   = {"ionosphere": 0.02,  "wbc": 0.02, "wdbc": 0.02,  "german": 0.005, "diabetes": 0.05,  "credit": 0.01,      "australian":0.01,   "wpbc": 0.01,  "trapezoid": 0.02  , "kr_vs_kp":0.01,  "svmguide3":0.01, "magic04":0.01, "imdb":0.01,  "synthetic":0.01  ,"a8a": 0.01  , "splice":0.01 , "dna": 0.01  , "hapt": 0.01  , "steamData": 0.01}
    window_size_denominators = {"ionosphere": 2,     "wbc": 2,    "wdbc": 2,     "german": 2,     "diabetes": 2,     "credit": 2,         "australian":2   ,   "wpbc": 8,     "trapezoid": 8     , "kr_vs_kp":2,     "svmguide3":2,    "magic04":2,    "imdb":2,     "synthetic":2     ,"a8a": 2     , "splice":4    , "dna": 4     , "hapt": 4     , "steamData": 4}
    batch_size_denominators  = {"ionosphere": 20,    "wbc": 8,    "wdbc": 8,     "german": 8,     "diabetes": 8,     "credit": 4,         "australian": 10  ,  "wpbc": 8,     "trapezoid": 8     , "kr_vs_kp":8,     "svmguide3":8,    "magic04":8,    "imdb":8,     "synthetic":8    ,"a8a": 8     , "splice":4    , "dna": 8     , "hapt": 8     , "steamData": 8}
    shuffles                 = {"ionosphere": True,  "wbc": False,"wdbc": True,  "german": False, "diabetes": True,  "credit": True,      "australian":False , "wpbc": False, "trapezoid": False , "kr_vs_kp":False, "svmguide3":True, "magic04":True, "imdb":False, "synthetic":False ,"a8a": False , "splice":True , "dna": False , "hapt": False , "steamData":False}
...
def Cumulative_error_rate_semi(predict_label_train_x_ensemble, predict_label_train_z_ensemble, Y_label_fill_x,
    ...
    plt.savefig("../Result/semi_images/" + dataset + "_Semi_supervised_model.png")
