...
"""
    This is Trapezoidal  Data Stream!
"""
if __name__ == "__main__":
    dataset = "wpbc" # "australian"
    ...
    X_zero = pd.read_csv("../dataset/MaskData/" + dataset + "/trapezoid/X_trapezoid_zeros.txt", sep = " ", header = None)
    ...
    # Constructing fill array or matrix
    ...
    # Define LinearSVC function or model
    ...
    while end <= n:
        ...
        Z_imp_batch, X_imp_batch = tra.partial_fit_and_predict(X_batch, cont_indices, ord_indices, max_workers = 1, decay_coef = 0.5)
